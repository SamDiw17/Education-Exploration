...
public class ZenModeMultiplication extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zen_mode_multiplication);

        Random inGen = new Random();
        int r1 = inGen.nextInt(10);
        int r2 = inGen.nextInt(10);
        String p = "Um... could you tell me what " + r1 + " x " + r2 + " is?";
    ...
    public void checkIn(View v){
        ...
        if (ans == b){
            ...
            Intent toSecondZen = new Intent(getApplicationContext(), ZenModeMultiplication.class);
